...
export class MembersReqList extends BaseComponent {
    ...
    componentDidMount() {
        GroupService.GetUsersWhoAskedToJoinGroup(this.props.groupId, 1, 6).then(
            (friends) => {
                this.setState({
                    UsersData: friends
                })
    ...
    nextPage() {
        GroupService.GetUsersWhoAskedToJoinGroup(this.props.groupId, this.state.UsersData.currentPage + 1, this.state.UsersData.pageSize).then(
            (friends) => {
                this.setState({
                    UsersData: friends
                })
